...
const VALUES = [
  ...
  { icon: "Clock", title: "Опыт работы", desc: "Более 10 лет на рынке промышленного оборудования" },
...
const DIRECTIONS = [
  {
    ...
    icon: "Droplets",
    page: "equipment-direction-hydraulics",
  },
  {
  ...
  },
  {
    ...
    icon: "Anchor",
    page: "equipment-direction-lifting",
  },
  {
    ...
    icon: "Cog",
    page: "equipment-direction-metalwork",
  },
  {
    title: "Сварочное оборудование",
    desc: "Аппараты для сварки MMA, MIG, TIG, Сварочные колонны, системы автоматизированной сварки.",
    icon: "Zap",
    page: "equipment-direction-welding",
  },
  {
    title: "Роботы и роботизированные решения",
    desc: "Роботизация в сварочных процессах, гибочных процессах, упаковке и логистике.",
    icon: "Bot",
    page: "equipment-direction-robots",
  },
  {
    title: "Металлоконструкции и металлообработка",
    desc: "Изготовление металлоконструкций по чертежам заказчика, резка, гибка, сварка, покраска. Поставка листового, профильного и трубного проката.",
    icon: "Layers",
    page: "metalwork",
  },
  {
    title: "Инжиниринг",
    desc: "Техническое консультирование, подбор оборудования под задачи предприятия, проектирование технологических линий, шефмонтаж и пусконаладка.",
    icon: "Settings2",
    page: "engineering",
  },
];
